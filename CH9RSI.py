...
\33[1;32m[[ AUTHOR NAME ]]      (( W9LII CH9RSII )) 

\33[1;32m[[ TOOL CREATED BY ]]  (( W9LII CH9RSII)) 
\33[1;32m -----------------------------------------------------------------------------------------
...
print ("[-[ TH3 T00L CREATE BY  W9LII CH9RSII ]-]") 
    ...
    print('\33[1;32m -----------------------------------------------------------------------------------------)
    delay = int(input('\033[1;36m [oye] Delay Seconds : '))
    print('\33[1;32m -----------------------------------------------------------------------------------------)
    lnk = input('\033[1;36m [oye] Chat/Inbox Link id : ')
    print('\33[1;32m -----------------------------------------------------------------------------------------)
    lim = int(input('\033[1;36m [oye] File Repeat : '))
    print('\33[1;32m -----------------------------------------------------------------------------------------)
    hater = input('\033[1;36m [hoye] Haters Name : ')
    print('\33[1;32m -----------------------------------------------------------------------------------------)
    filee = input('\033[1;36m [hoye] File : ')
    ...
    with bsn(max_workers=30) as crack:
        ...
        logo()
        print('')
        print(' \033[1;33m[oye] Total messages : %s' %(len(file)))
